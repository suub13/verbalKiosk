...
export function ConversationView() {
  ...
  // 실제로 듣고 있는 상태: voiceState=listening + isMuted=false면 항상 표시
  // (verify/sign 단계에서도 마이크 버튼으로 임시 열면 오버레이 보여야 함)
  const MIC_INACTIVE_STEPS = ['verify', 'options', 'sign', 'issue'];
  const isActuallyListening = voiceState === 'listening' && !isMuted;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 음성 인식 중간 결과 오버레이 */}
        {(partialTranscript || isActuallyListening) && (
          <div
