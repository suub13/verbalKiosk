...
kiosk_ys_03_17_03 originated

## 버전 변경
03_17_2시_1차시연용 + 실행파일변경
03_17_3시_ 키보드_변경 및 크기조절
03_17_4시_ 알뜰폰 컬러변경
03_17_5시 변경 - 키오스크 증명단계 수정
03_18 9시 영서 & 수빈 코드 merge
03_18 11시 중간 단계에서 멈추는 부분 해결 및 sign 단계 외 음성인식도 낮춤
03_19 2시 선택발급 부분에서 답변 가능하게끔 prompt 추가 및 음성인식도 조절
03_18_4시 영서 & 수빈 코드 merge :2차 시연최종본 / 키보드 이름 입력안되도록 막음, 키보드 포커싱 풀리는거 막음

## 아키텍처 대응표origin/kiosk_sb_0318_10
